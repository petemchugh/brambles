...
source('~/BrambleCloudLCM4/Watershed_ReadData.R', encoding = 'UTF-8')
#source("Watershed_MonteCarlo.r")
source('~/BrambleCloudLCM4/Watershed_MonteCarlo.R', encoding = 'UTF-8')
...
source('~/BrambleCloudLCM4/Watershed_BevHolt_NFLewisMAupd.R', encoding = 'UTF-8')
#source("Watershed_Post_Processing.r")
source('~/BrambleCloudLCM4/Watershed_Post_Processing.R', encoding = 'UTF-8')
#source("Watershed_JohnDayOutputs.r") #Only use this if you're interested; it's for 1 pop and hasn't been vetted for Chinook
source('~/BrambleCloudLCM4/Watershed_JohnDayOutputs.R', encoding = 'UTF-8')
...
WriteJohnDayOut(outstuff,'sub',gtypeIn,FALSE,21,60,'JCE_50')#Pete July 2016 version
