...
source('~/BrambleCloudLCM6/Watershed_ReadData.R', encoding = 'UTF-8')
#source("Watershed_MonteCarlo.r")
source('~/BrambleCloudLCM6/Watershed_MonteCarlo.R', encoding = 'UTF-8')
...
source('~/BrambleCloudLCM6/Watershed_BevHolt_NFLewisMAupd.R', encoding = 'UTF-8')
#source("Watershed_Post_Processing.r")
source('~/BrambleCloudLCM6/Watershed_Post_Processing.R', encoding = 'UTF-8')
#source("Watershed_JohnDayOutputs.r") #Only use this if you're interested; it's for 1 pop and hasn't been vetted for Chinook
source('~/BrambleCloudLCM6/Watershed_JohnDayOutputs.R', encoding = 'UTF-8')
...
WriteJohnDayOut(outstuff,'sub',gtypeIn,FALSE,21,60,'BaseSwift')#Pete July 2016 version
